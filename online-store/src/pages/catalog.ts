    ...
    <div class="filters">
        ...
        <div class="filters__box">
            ...
            <ul class="filters__list" id="theme-filters">
                <li class="checkbox__box">
                    <input class="checkbox__input checkbox_theme" id="theme_1" idAPI="abstract" type="checkbox">
                    <label class="checkbox__label" for="theme_1">Abstract
                        <span class="checkbox__counter">23</span>
                    </label>
                </li>
                <li class="checkbox__box">
                    <input class="checkbox__input checkbox_theme" id="theme_2" idAPI="adventure" type="checkbox">
                    <label class="checkbox__label" for="theme_2">Adventure
                        <span class="checkbox__counter">23</span>
                    </label>
                </li>
                <li class="checkbox__box">
                    <input class="checkbox__input checkbox_theme" id="theme_3" idAPI="building" type="checkbox">
                    <label class="checkbox__label" for="theme_3">Building
                        <span class="checkbox__counter">23</span>
                    </label>
                </li>
                <li class="checkbox__box">
                    <input class="checkbox__input checkbox_theme" id="theme_4" idAPI="card-game" type="checkbox">
                    <label class="checkbox__label" for="theme_4">Card-game
                        <span class="checkbox__counter">23</span>
                    </label>
                </li>
                <li class="checkbox__box">
                    <input class="checkbox__input checkbox_theme" id="theme_5" idAPI="cooperative" type="checkbox">
                    <label class="checkbox__label" for="theme_5">Cooperative
                        <span class="checkbox__counter">23</span>
                    </label>
                </li>
                <li class="checkbox__box">
                    <input class="checkbox__input checkbox_theme" id="theme_6" idAPI="deduction" type="checkbox">
                    <label class="checkbox__label" for="theme_6">Deduction
                        <span class="checkbox__counter">23</span>
                    </label>
                </li>
                <li class="checkbox__box">
                    <input class="checkbox__input checkbox_theme" id="theme_7" idAPI="economic" type="checkbox">
                    <label class="checkbox__label" for="theme_7">Economic
                        <span class="checkbox__counter">23</span>
                    </label>
                </li>
                <li class="checkbox__box">
                    <input class="checkbox__input checkbox_theme" id="theme_8" idAPI="fantasy" type="checkbox">
                    <label class="checkbox__label" for="theme_8">Fantasy
                        <span class="checkbox__counter">23</span>
                    </label>
                </li>
                <li class="checkbox__box">
                    <input class="checkbox__input checkbox_theme" id="theme_9" idAPI="fighting" type="checkbox">
                    <label class="checkbox__label" for="theme_9">Fighting
                        <span class="checkbox__counter">23</span>
                    </label>
                </li>
                <li class="checkbox__box">
                    <input class="checkbox__input checkbox_theme" id="theme_11" idAPI="sci-fi" type="checkbox">
                    <label class="checkbox__label" for="theme_11">Sci-Fi
                        <span class="checkbox__counter">23</span>
                    </label>
                </li>
                <li class="checkbox__box">
                    <input class="checkbox__input checkbox_theme" id="theme_12" idAPI="wargame" type="checkbox">
        ...
        <div class="filters__box">
            ...
            <ul class="filters__list"  id="publisher-filters">
                ...
                <li class="checkbox__box">
                    <input class="checkbox__input checkbox_publisher" id="brand_2" idAPI="Space-Cowboys" type="checkbox">
                    <label class="checkbox__label" for="brand_2">Space Cowboys
                        <span class="checkbox__counter">11</span>
                    </label>
                </li>
                <li class="checkbox__box">
                    <input class="checkbox__input checkbox_publisher" id="brand_3" idAPI="IELLO" type="checkbox">
                    <label class="checkbox__label" for="brand_3">IELLO
                        <span class="checkbox__counter">11</span>
                    </label>
                </li>
                <li class="checkbox__box">
                    <input class="checkbox__input checkbox_publisher" id="brand_4" idAPI="Feuerland-Spiele" type="checkbox">
                    <label class="checkbox__label" for="brand_4">Feuerland Spiele
                        <span class="checkbox__counter">11</span>
                    </label>
                </li>
                <li class="checkbox__box">
                    <input class="checkbox__input checkbox_publisher" id="brand_5" idAPI="Repos-Production" type="checkbox">
                    <label class="checkbox__label" for="brand_5">Repos Production
                        <span class="checkbox__counter">11</span>
                    </label>
                </li>
                <li class="checkbox__box">
                    <input class="checkbox__input checkbox_publisher" id="brand_6" idAPI="Rio-Grande-Games" type="checkbox">
                    <label class="checkbox__label" for="brand_6">Rio Grande Games
                        <span class="checkbox__counter">11</span>
                    </label>
                </li>
                <li class="checkbox__box">
                    <input class="checkbox__input checkbox_publisher" id="brand_7" idAPI="Z-Man-Games" type="checkbox">
